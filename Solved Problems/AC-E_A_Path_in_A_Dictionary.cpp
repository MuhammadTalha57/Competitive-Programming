...
bool dfs(int u, vvi& mat, vi& parent, int p) {
    parent[u] = p;
    ...
    rep(v, 1, mat.size()) {
        if(mat[u][v] == 1 && parent[v] == -1) {
            if(dfs(v, mat, parent, u)) {return true;}
...
// Problem Link: https://atcoder.jp/contests/abc417/tasks/abc417_e
