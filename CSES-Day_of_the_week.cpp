...
void solve() {
    ...
    chrono::day day = chrono::day(d);
    chrono::month month = chrono::month(m);
    chrono::year year = chrono::year(y);


    chrono::year_month_day date = chrono::year_month_day(year, month, day);
    int ans = chrono::weekday(date).c_encoding();
    vector<string> days = {
    "sunnuntai",   // Sunday
    "maanantai",   // Monday
    "tiistai",     // Tuesday
...
// Problem Link: https://cses.fi/dt/task/316
